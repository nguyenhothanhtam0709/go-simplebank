...
import (
	...
	mockdb "github.com/nguyenhothanhtam0709/go-simplebank/db/mock"
...
func (e eqCreateUserParamsMatcher) Matches(x interface{}) bool {
	...
	if err := utils.CheckPassword(e.password, args.HashedPassword); err != nil {
		return false
	}
...
func (e eqCreateUserParamsMatcher) String() string {
	return fmt.Sprintf("match args %v and password %v", e.args, e.password)
}
...
func TestCreateUserAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			buildStubs: func(store *mockdb.MockStore) {
				store.EXPECT().CreateUser(gomock.Any(), gomock.Any()).Times(1).Return(db.User{}, utils.PqErrUniqueViolation)
			},
			checkResponse: func(recorder *httptest.ResponseRecorder) {
